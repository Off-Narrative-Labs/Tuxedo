...
pub fn aggregate(attrs: TokenStream, body: TokenStream) -> TokenStream {
    ...
    if !attrs.is_empty() {
        ...
        tuxedo_trait_impl = if ident_is_named(&attrs_tree, "Verifier") {
            ...
            //TODO do I need this? Can I just use error_type_name directly?
            ...
            quote! {
                ...
                /// 
                /// I'm not sure whether downstream developers will need to refer to this type
                /// in their code yet. The template runtime currently doesn't. Nonetheless,
                /// it is available as `<OuterConstraintChecker as ConstraintChecker>::Error`
                #[derive(Debug)]
                #vis enum #error_type {
                    #(
                ...
                impl tuxedo_core::ConstraintChecker for #outer_type {
                    ...
                    fn check<V: tuxedo_core::Verifier>(
                        ...
                        match self {
                            #(
                                Self::#variants2(inner) => inner.check(inputs, outputs).map_err(|e| Self::Error::#variants3(e)),
                            )*
                        }
                    }
                }
